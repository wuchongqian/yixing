...
public class ActivityController {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(paramType = "query", name = "imageId", value = "活动图片ID", required = true, dataType = "int", defaultValue = "1"),
            @ApiImplicitParam(paramType = "query", name = "deadline", value = "截止日期", required = true, dataType = "int", defaultValue = "10"),
            @ApiImplicitParam(paramType = "query", name = "token", value = "通讯密串", required = true, dataType = "String")
    })
    @RequestMapping(value = "/addActivityInfo", method = {RequestMethod.GET})
    ...
    @RequestMapping(value = "/updateActivityDeadline", method = {RequestMethod.GET})
