...
public class MiniProgramController {
    ...
    public ResultContent addRegisterInfo(String activityId, String authorName, String phone, String worksName, String introductionOfWorks, String token) throws IOException{
        return activityServiceImpl.addRegisterInfo(activityId, authorName, phone, worksName, introductionOfWorks, token);
    }
